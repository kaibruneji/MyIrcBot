...
#"(!курс эксмо)" - юзер получает курсы валют. Писать можно в любом месте текста.
#"(!где айпи) 122.00.00.01" - юзер получает гео-данные данного IP.
#"(!k) ghbdtn" - перевод английских букв на русские, либо просто (!k) для перевода предыдущего сообщения.
#"(!q) текст для поиска цитаты или номер цифрами" - поиск цитаты.
#"(!aq) текст для добавления в цитаты" - добавляет новую цитату
...
#"(!<имя бота> quit)" - закрывает программу.
...
#"(!dq) номер цитаты" - удаляет цитату пономеру.
